...
// class member functions
    AquaDevice::AquaDevice(AquaWindow &window) : window{window} {
        createInstance();
        setupDebugMessenger();
        createSurface();
        pickPhysicalDevice();
    ...
    void AquaDevice::createSurface() { window.createWindowSurface(instance, &surface_); }
    ...
    uint32_t AquaDevice::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
